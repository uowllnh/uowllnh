...
React와 TypeScript를 중심으로 웹과 모바일 프론트엔드 개발 역량을 쌓고 있습니다.
...
엽기떡볶이 웹서비스의 메뉴 탐색 경험을 개선하기 위해 제작한 개인 리디자인 프로젝트입니다.
...
사용자 정보를 기반으로 적합한 통신 요금제를 추천하는 Android 모바일 애플리케이션입니다.
프론트엔드 개발과 전체 UI 설계를 담당했습니다.

* 사용자 정보 기반 요금제 추천
* 요금제 정보 조회 및 비교
* Android 모바일 UI 설계 및 구현
* 백엔드 API 연동
* 팀원과의 협업 및 화면 개발
...
뽀모도로 집중 기법을 활용해 일정과 집중 시간을 관리할 수 있도록 제작한 Android 플래너 애플리케이션입니다.

* 뽀모도로 타이머
* 일정 및 할 일 관리
* 집중 시간 기록
* 직관적인 일정 관리 UI
* XML 기반 Android 화면 구현
...
스크롤과 화면 전환에 따라 콘텐츠가 자연스럽게 나타나도록 인터랙션을 구현했습니다.
...
[🔗 GitHub](https://github.com/uowllnh/uowllnh.github.io) · [🌐 Portfolio](https://uowllnh.github.io/portfolio/)

---

### 💍 Wedding Invitation

React와 Next.js를 기반으로 제작한 모바일 청첩장 웹서비스입니다.
하객이 모바일 환경에서 예식 정보와 위치를 확인하고, 참석 여부를 전달할 수 있도록 구현했습니다.
...
<p>
  ...
  <img src="https://img.shields.io/badge/Riverpod-00A8E8?style=flat-square&logo=flutter&logoColor=white"/>
  <img src="https://img.shields.io/badge/GoRouter-02569B?style=flat-square&logo=flutter&logoColor=white"/>
  <img src="https://img.shields.io/badge/Firebase_Authentication-FFCA28?style=flat-square&logo=firebase&logoColor=black"/>
  ...
  <img src="https://img.shields.io/badge/Naver_Map-03C75A?style=flat-square&logo=naver&logoColor=white"/>
  <img src="https://img.shields.io/badge/Personal_Project-6C63FF?style=flat-square"/>
</p>
...
<p>
[![uowllnh's GitHub stats](https://github-stats-extended.vercel.app/api?yoooory=anuraghazra)](https://github.com/stats-organization/github-stats-extended)
  <p/>
<p>
